 ...
 void frontscreen(void)
{
    ...
    glColor3f(1,1,1);
	output(35,160," DON DOSCO INSTITUTE OF TECHNOLOGY");
	glColor3f(1,1,1);
	output(5,150,"DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING");
	glColor3f(1,0,1);
	output(60,130,"A Computer Graphics Mini Project On :-");
	glColor3f(0,1,0.5);
	...
	glEnd();
	glColor3f(1,0,0);
	output(40,90,"BHAVANA M ");
	output(40,80,"BINDU J ");
	output(40,70,"DHANALASHMI C ");
	output(40,60,"DIPA SHARMA ");


	output(40,50,"");
	glColor3f(1,0,1);
	output(40,40,"Under the Guidance of :-");
	glBegin(GL_LINES);
	glVertex2f(40,58);
	glVertex2f(98,58);
	glEnd();
	...
	output(40,50,"");
	glColor3f(1,0,0);
	output(60,30,"Prof. Suresh Kumar C");
	glColor3f(1,0,0);
